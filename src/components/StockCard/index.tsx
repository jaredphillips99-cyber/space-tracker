...
export function StockCard({ ticker }: { ticker: string }) {
  ...
  return (
    <div className="flex flex-col gap-6 p-6 max-w-3xl mx-auto">
      ...
      {/* Key metrics */}
      <div className="grid grid-cols-4 gap-4 p-4 rounded-lg" style={{ backgroundColor: '#0f1117', border: '1px solid #1e2030' }}>
      ...
      {/* Analysis status */}
      <div className="rounded-lg overflow-hidden" style={{ border: '1px solid #1e2030' }}>
        <div className="flex items-center justify-between px-4 py-3" style={{ backgroundColor: '#0f1117', borderBottom: '1px solid #1e2030' }}>
